...
export type GetStyleInfo = (resolved: { element: Element | null }) => { className: string; styles: Record<string, string> | null };
export const initDesignMode = (getStyleInfo: GetStyleInfo) => { return () => {}; };
