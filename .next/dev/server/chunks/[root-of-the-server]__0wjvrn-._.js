...
"[project]/src/app/manifest.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function manifest() {
    return {
        ...
        short_name: 'BGMI Stylist',
        description: 'Generate stylish BGMI names instantly with Unicode fonts and special symbols.',
        start_url: '/',
        display: 'standalone',
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$manifest$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/manifest.js [app-route] (ecmascript)");
...
if (typeof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$manifest$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"] !== 'function') {
    throw new Error('Default export is missing in "./manifest.js"');
}
async function GET() {
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$manifest$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0wjvrn-._.js.map